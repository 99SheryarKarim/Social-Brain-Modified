        ...
        <div style={{
          ...
          <div style={{ flexGrow: 1 }}>
            <p style={{ margin: 0, fontWeight: 600, color: '#92400e', fontSize: 14 }}>
              You've used {plan.daily_usage} of {plan.limit} free generations today
            </p>
      ...
      <div className="row g-4 mb-5">
        ...
        <div className="col-md-6">
          <div style={{
            ...
            borderRadius: 20, padding: '32px', height: '100%', position: 'relative', overflow: 'hidden'
          }}>
            ...
            {isPremium ? (
              <div style={{ background: 'rgba(255,255,255,0.15)', borderRadius: 10, padding: '12px 16px', textAlign: 'center', fontSize: 14, color: '#a5b4fc', fontWeight: 600 }}>
                ✓ You're on Premium
              </div>
            ) : (
