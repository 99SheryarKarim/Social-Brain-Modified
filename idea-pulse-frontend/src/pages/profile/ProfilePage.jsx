      ...
      <div style={{
        ...
        <div style={{
          background: isPremium
            ...
            : 'linear-gradient(135deg, #e8f6f5, #d4f0ee)',
        ...
        <div style={{ padding: '0 28px', marginTop: -40 }}>
          <div style={{
            ...
            boxShadow: isPremium ? '0 4px 16px rgba(245,158,11,0.4)' : '0 4px 16px rgba(70,162,159,0.25)'
          }}>
        ...
        <div style={{ padding: '16px 28px 28px' }}>
          <h2 style={{ margin: '0 0 4px', fontWeight: 700, fontSize: 22, color: '#1e293b' }}>{username}</h2>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 24 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '12px 16px', background: '#f8fafc', borderRadius: 10 }}>
              <i className="fas fa-envelope" style={{ color: '#46a29f', fontSize: 14, width: 16 }} />
              <div>
            ...
            {plan && !isPremium && (
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '12px 16px', background: '#f8fafc', borderRadius: 10 }}>
                <i className="fas fa-chart-bar" style={{ color: '#46a29f', fontSize: 14, width: 16 }} />
                <div style={{ flexGrow: 1 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 4 }}>
                    <div style={{ flexGrow: 1, background: '#e2e8f0', borderRadius: 20, height: 6, overflow: 'hidden' }}>
                      <div style={{
                        ...
                        background: plan.daily_usage >= plan.limit ? '#ef4444' : '#46a29f',
