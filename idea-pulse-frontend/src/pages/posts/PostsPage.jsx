      ...
      <div style={{
        ...
        <div style={{ padding: '20px 24px 0', borderBottom: '1px solid #f1f5f9' }}>
          <div className="d-flex justify-content-between align-items-center mb-3">
            <h6 style={{ margin: 0, fontWeight: 700, color: '#1e293b' }}>Post Engagement</h6>
            ...
            data.reactions.length === 0
              ...
              : data.reactions.map((r, i) => (
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '10px 0', borderBottom: '1px solid #f8fafc' }}>
                  <img src={r.pic_square || `https://ui-avatars.com/api/?name=${encodeURIComponent(r.name)}&size=36&background=46a29f&color=fff`}
              ...
              : data.comments.map((c, i) => (
                <div key={i} style={{ padding: '12px 0', borderBottom: '1px solid #f8fafc' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 6 }}>
                    <div style={{
                      width: 32, height: 32, borderRadius: '50%', background: 'linear-gradient(135deg,#46a29f,#3b8c86)',
        ...
        <>
          ...
          {posts.length === 0 && !loading && (
            <div className="text-center py-5">
              ...
              <p className="text-muted">No posts generated yet. Go to Idea Pulse to create some!</p>
            </div>
          )}
          <div className="row">
