# Idea Pulse FYP - Simplification Proposal
## Option 2: Simplified Backend Approach

**Document Version:** 1.0  
**Date:** April 16, 2026  
**Project:** Idea Pulse (AI-Powered Social Media Content Generator)  
...
This document outlines a proposal to **simplify the Idea Pulse FYP project** from a complex 3-service microservices architecture to a **more manageable 2-service approach**. This simplification will:
